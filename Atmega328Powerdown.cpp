...
Atmega328Powerdown::Atmega328Powerdown(voltage_t voltage)
{
  _voltage = voltage;
  // CPU Sleep Modes
...
void Atmega328Powerdown::save(int interval)
{
  awake_flag = 0;
  switch(_voltage) {
    case VOLTAGE_3V:
...
boolean Atmega328Powerdown::awake()
{
  return awake_flag;
}
/*
 ...
 */
void Atmega328Powerdown::calculateWaitPeriods5V(unsigned long sleep) {
...
void Atmega328Powerdown::calculateWaitPeriods3V(unsigned long sleep) {
 ...
 */
void Atmega328Powerdown::doSleep(){
  //sleep routine
  for (byte i=7;i>0;i--){
    //set sleep time
    setup_watchdog(i);
 ...
 */
void Atmega328Powerdown::sleep3V(unsigned long sleep) {
 ...
 */
void Atmega328Powerdown::sleep5V(unsigned long sleep) {
...
void Atmega328Powerdown::system_sleep() {
 ...
 */
void Atmega328Powerdown::setup_watchdog(int ii) {
